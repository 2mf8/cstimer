<h1>csTimer version <?php echo $version;?> - 魔方竞速训练专用计时器<br/>孙氏魔方中文标记V3.0版</h1>
<?php include('lang.php') ?>
<h2>简介</h2>
<p>csTimer孙氏魔方中文标记V3.0版是基于csTimer精简、标记汉化而来，源网站为 <a class="click" href="https://cstimer.net/">csTimer</a></p>
